...
class CheckLogin extends CI_Controller {
 ...
 {  
	...
	$this->Employee->setEmpUsername($username); //// set ค่า username ใน Model Employee
	$this->Employee->setEmpPassword($password); //// set ค่า password ใน Model Employee
	
	$data = $this->Employee->login();  ///// เรียกใช้ ฟังชั่น login ใน Model Employee และน้ำตัวแปล $data มารับค่าที่ return กลับมา
